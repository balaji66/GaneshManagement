...
public class BalloonRegisteredPlalyersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_balloon_registered_plalyers);
        initializeViews();
    ...
    public void signIn()
    {
        ...
        Call<List<Game>> call = APIUrl.getmInstance().getApi().registeredPlayerBalloon();
        ...
        call.enqueue(new Callback<List<Game>>() {
            ...
            public void onResponse(@NonNull Call<List<Game>> call, @NonNull Response<List<Game>> response) {
                ...
                adapter = new GameAdapter(list, BalloonRegisteredPlalyersActivity.this);
            ...
            public void onFailure(@NonNull Call<List<Game>> call, @NonNull Throwable t) {
                ...
                final AlertDialog alertDialog =new AlertDialog.Builder(BalloonRegisteredPlalyersActivity.this).create();
