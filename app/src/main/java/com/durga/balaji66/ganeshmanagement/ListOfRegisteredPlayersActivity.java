...
import com.durga.balaji66.ganeshmanagement.Adapters.RegisteredPlayerListAdapter;
...
public class ListOfRegisteredPlayersActivity extends AppCompatActivity {
    private RecyclerView recyclerViewMessages;
    private RegisteredPlayerListAdapter adapter;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_list_of_registered_players);
        initializeViews();
    ...
    public void signIn()
    {
        ...
        Call<List<Game>> call = APIUrl.getmInstance().getApi().getAllRegisteredPlayers();
        ...
        call.enqueue(new Callback<List<Game>>() {
            ...
            public void onResponse(@NonNull Call<List<Game>> call, @NonNull Response<List<Game>> response) {
                ...
                for(Game g : list)
                {
                    ...
                    Log.d("mobile_number",g.getMobile_number());
                }

                adapter = new RegisteredPlayerListAdapter(list, ListOfRegisteredPlayersActivity.this);
            ...
            public void onFailure(@NonNull Call<List<Game>> call, @NonNull Throwable t) {
                ...
                final AlertDialog alertDialog =new AlertDialog.Builder(ListOfRegisteredPlayersActivity.this).create();
